...
function integrateNormalButtonsIntoWpContent($dd_normal_button_for_display, $content, $dd_line_up){
	...
	if($dd_after_content!=DD_EMPTY_VALUE){
		$dd_after_content = "<div id=\"share_slider\"><div class='dd_post_share'><div class='dd_buttons'>" . $dd_after_content. "</div><div style='clear:both'></div></div>"
		.'<div class="share_caption" >Se ti &egrave; piaciuto questo articolo, condividilo con i tuoi amici, utilizzando i pulsanti a sinistra.<br/>In questo modo aiuterai <b>Temperamente.it</b> a crescere</div></div>';
	}
